...
# --- রেলওয়ে লগিং সিস্টেম (ক্রাশ চেক করার জন্য) ---
logging.basicConfig(
...
# --- জেনারেটর ফাংশনসমূহ (পূর্ণাঙ্গ রূপ) ---
def generate_infinite_user_agent():
    ...
    build_ids = ["UP1A.231005.007", "TP1A.220624.014", "SKQ1.211006.001"]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "🔥 **M R DEVELOPER GLOBAL BAN ENGINE v9.5** 🔥\n\n"
        "রেলওয়ে সার্ভারের জন্য অপ্টিমাইজড এবং ক্রাশ-ফ্রি ভার্সন।\n\n"
...
async def stop_attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🛑 **STOP REQUESTED.**", reply_markup=ReplyKeyboardRemove())

# --- ২. কোর ইঞ্জিন (ANTI-CRASH) ---
async def run_global_mission(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_msg = await update.message.reply_text(f"📡 কানেক্ট হচ্ছে: {target}...", reply_markup=stop_markup)
    ...
    try:
        for i in range(1, 1001):
            ...
            if i % 10 == 0 or i == 1000:
                try:
                    ...
                    await asyncio.sleep(4) # রেলওয়ে সেফটি ডিলে
        ...
        await status_msg.edit_text(f"✅ **MISSION COMPLETE!**\n📊 মোট রিপোর্ট: ১০০০/১০০০\n📢 ফলাফল: ২-৫ ঘণ্টার মধ্যে ব্যান হবে।", reply_markup=ReplyKeyboardRemove())
...
# --- ৩. মেইন রানার ---
def main():
    # রেলওয়েতে ক্রাশ এড়াতে শক্তিশালী রিকানেক্ট পলিসি
    application = Application.builder().token(TOKEN).connect_timeout(40).read_timeout(40).build()
